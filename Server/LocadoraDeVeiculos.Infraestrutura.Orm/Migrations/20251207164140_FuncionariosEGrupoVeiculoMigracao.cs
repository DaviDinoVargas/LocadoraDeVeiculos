...
{
    /// <inheritdoc />
    public partial class FuncionariosEGrupoVeiculoMigracao : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubstituidoPorTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IpCriacao = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GruposAutomovel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GruposAutomovel_AspNetUsers_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GruposAutomovel_EmpresaId_Excluido",
                table: "GruposAutomovel",
                columns: new[] { "EmpresaId", "Excluido" });

            migrationBuilder.CreateIndex(
                name: "IX_GruposAutomovel_EmpresaId_Nome",
                table: "GruposAutomovel",
