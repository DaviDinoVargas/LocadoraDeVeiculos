...
{
    public class CadastrarClientePessoaJuridicaCommandValidator : AbstractValidator<CadastrarClientePessoaJuridicaCommand>
    {
        public CadastrarClientePessoaJuridicaCommandValidator()
        {
            RuleFor(p => p.Nome)
