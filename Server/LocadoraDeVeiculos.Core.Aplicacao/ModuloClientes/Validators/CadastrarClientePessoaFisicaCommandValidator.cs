...
{
    public class CadastrarClientePessoaFisicaCommandValidator : AbstractValidator<CadastrarClientePessoaFisicaCommand>
    {
        public CadastrarClientePessoaFisicaCommandValidator()
        {
            RuleFor(p => p.Nome)
